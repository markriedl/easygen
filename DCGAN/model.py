...
class DCGAN(object):
  def __init__(self, sess, input_height=108, input_width=108, crop=True,
         ...
         input_fname_pattern='*.jpg', checkpoint_dir=None, sample_dir=None, output_dir=None):
    """
  ...
  def train(self, epoch = 25, learning_rate = 0.0002, beta1 = 0.5, train_size = np.inf, batch_size = 64, input_height = 108, input_width = None, output_height = 64, output_width = None, dataset = 'celebA', input_fname_pattern = '*.jpg', checkpoint_dir = 'checkpoints', sample_dir = 'samples', output_dir = 'output', train = False, crop = False):
    ...
    for epoch in xrange(epoch):
      if dataset == 'mnist':
        batch_idxs = min(len(self.data_X), train_size) // batch_size
      else:      
        self.data = glob(os.path.join(
          ".", dataset, self.input_fname_pattern))
